...
% Last Modified by GUIDE v2.5 20-Dec-2020 20:15:11
...
if(Affect<25)
    msgbox('NORMAL LEAF'); 
elseif(Affect>25 && Affect<50)
msgbox('Cercospora leaf spot'); 
elseif(Affect>50 && Affect<75)
msgbox('Powdery mildew'); 
else 
msgbox('Anthracnose');
end 
